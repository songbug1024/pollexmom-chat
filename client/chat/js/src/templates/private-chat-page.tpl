<div class="bar bar-header bar-positive">
  <a class="back-btn button icon-left ion-ios-arrow-left button-clear button-light">返回群聊</a>
  <h1 class="chat-to-name title">{{=chatToName}}</h1>
...
<div class="chat-input-bar bar bar-footer bar-stable">
  ...
  <label class="msg-input-label item item-input">
    <input class="msg-input" type='text' placeholder="和他（她）说两句...">
  </label>
